...
//exit();
	...
	public function print_workorder(){
		...
		$this ->load->view("Content_workorder_print2", $data);	
		}else{
	...
	//echo $wrkno;
	    ...
	    $this ->load->view("headprinter");
		$this ->load->view("Content_workorder_print2.php", $data);	
		//echo "<pre>";
     //	print_r($data['woinfo2']);
		}
...
//		}
	...
	public function report_rtlu(){
		...
		$data['month']= ($this->input->get('m') <> 0) ? sprintf("%02d", $this->input->get('m')) : date("m");
		$data['grpsel']= $this->input->get('grp') ? $this->input->get('grp') : '';
		$data['record'] = $this->display_model->rpt_rtlu($data['month'],$data['year'], $this->input->get('stat'),$data['grpsel'],$data['reqtype']);
		//$this ->load->view("headprinter");
...
//exit();
  ...
  public function del_filebank(){
	...
	public function ttlexp(){
		$data['year']= ($this->input->get('y') <> 0) ? $this->input->get('y') : date("Y");	
		$data['month']= ($this->input->get('m') <> 0) ? sprintf("%02d", $this->input->get('m')) : date("m");
		$data['range']= ($this->input->get('range')!="") ? ( $this->input->get('range')!="cur" ? $this->input->get('range') : "0" ) : "0";
		// echo $data['range'];die;
		$this->load->model('display_model');
