...
<style type="text/css" media="print">
	...
	.tbl-wo-1 tr .tbl-wo-data2{
    width: 30%;
  }
  textarea.xxtextareaxx{
	font-size:9px;}
  td.tbl-wo-data{
  	width: 25%;
  }
   table.tbl-wo-1 tr td , table.tbl-wo tr td{
    font-size: 9px;
  }
...
table.tbl-size tr th,table.tbl-size tr td,table.ui-float-asset-reg tr th {
	font-size:9px;}
	div.divFooter {
            position: fixed;
            bottom: 0;
