				...
				<div class="middle_d">
					<table width="100%" class="ui-content-form-reg" style="">
						<tr class="ui-color-contents-style-1" height="30px">
							<td colspan="2" class="ui-header-new"><b>New Booking</b></td>
						</tr>
						<tr >
			...
			<tr class="ui-color-contents-style-1">
				...
				<?php $numrow = 1; foreach($recordbook as $row):?>
						...
						<tr align="center" style="background:white; height:200px;">
	    					<td colspan="10"><span style="color:red; text-transform: uppercase;">NO BOOKING FOUND FOR <?=date('F', mktime(0, 0, 0, $month, 10))?> <?=$year?>.</span>
							</td>
	    				</tr>
						<?php } ?>	 
					</table>
