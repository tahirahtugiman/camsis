<?php echo form_open('qap3_car_action_update_ctrl/confirmation');?>
<div class="ui-middle-screen">
	<div class="content-workorder" align="center">
		<table class="ui-content-middle-htd">
			<tr class="ui-color-contents-style-1" height="40px">
				<td colspan="2" class="ui-header-new" valign="top"><span style="float: left; margin-top:8px; font-weight: bold;">Confirm Edit Action for <?= $this->input->post('carid') ?> of SIQ <?= $this->input->post('ssiq') ?></span></td>
			</tr>
			<tr >
				<td class="ui-desk-style-table">
					<table class="ui-content-form" width="100%" border="0">	
						...
						<tr style="height:20px;">
							...
							<td><?php echo set_value('sl_no') ?></td>
						</tr>
						<tr style="height:20px;">
							<td class="td-assest2">Action Description :</td>
							<td><textarea class="input n_com" name="n_actdesc"><?php echo set_value('n_actdesc') ?></textarea></td>
						</tr>
						<tr style="height:20px;">
		...
		<?php echo form_hidden('sl_no',$this->input->post('sl_no')) ?>
