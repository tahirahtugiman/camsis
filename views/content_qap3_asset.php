	...
	<div class="content-workorder">
		<table class="ui-content-middle-menu-workorder" border="0" height="" width="80%" align="center">
			...
			<tr class="" height="40px" style="color:white;">
				<td class="ui-middle-color assets-headear" colspan="3" style="padding-left:10px;"><b>Asset With SIQ <?=date('F', mktime(0, 0, 0, $month, 10))?> <?=$year?></b><br /><span style="font-size:14px;"><i>The following assets were evaluated. SIQ has been generated for these assets.</i></span></td>
			</tr>
				...
				<td colspan="12" height="40px">
					<table width="100%" class="ui-content-middle-menu-desk">
						<tr>
							...
							<a href="?y=<?= $year-1?>&m=<?= $month?>&tab=1&asst=0"><img src="<?php echo base_url(); ?>images/arrow-left2.png" alt="" class="ui-img-icon" style="padding-top:4px; padding-left:4px;"/></a>
							</td>
							<td width="3%">
							<a href="?y=<?= ($month-1 == 0) ? $year-1 :$year?>&m=<?= ($month-1 == 0) ? 12 :$month-1?>&tab=1&asst=0"><img src="<?php echo base_url(); ?>images/arrow-left.png" alt="" class="ui-img-icon" style="padding-top:4px; padding-left:4px;"/></a>
							</td>
							<td width="88%" align="center">
							<?=date('F', mktime(0, 0, 0, $month, 10))?> <?=$year?>
							</td>
							<td width="3%">
							<a href="?y=<?= ($month+1 == 13) ? $year+1 :$year?>&m=<?= ($month+1 == 13) ? 1 :$month+1?>&tab=1&asst=0"><img src="<?php echo base_url(); ?>images/arrow-right.png" alt="" class="ui-img-icon" style="padding-top:4px; padding-left:4px;"/></a>
							</td>
							<td width="3%">
							<a href="?y=<?= $year+1?>&m=<?= $month?>&tab=1&asst=0"><img src="<?php echo base_url(); ?>images/arrow-right2.png" alt="" class="ui-img-icon" style="padding-top:4px; padding-left:4px;"/></a>
							</td>
						</tr>
					</table>
				</td>
				...
				<td style="" width="" colspan="12" valign="top" align="center">
					...
					<table class="ui-desk-style-table" style="color:black; background:white; text-align:center;" cellpadding="4" cellspacing="0" width="100%">      			
	    				...
	    				?>  
							...
							<?php if ($target > 0) { ?>
							<td><div><center><table cellpadding="0" cellspacing="0" style="background-color:;border-collapse: collapse;"><tr width="35px"><td style="font-size:7.5pt;color:#FF0000;"><?php echo $Uptime_pct ?>%&nbsp;</td><td nowrap style="border:0px solid #aaaaaa;"><img src="<?php echo base_url(); ?>images/barchtpink.gif" width="<?php echo $UptimeWidth ?>" height="12"><img src="<?php echo base_url(); ?>images/barchtgrey.gif" width="<?php echo $TargetWidth ?>" height="12"></td><td style="font-size:7.5pt;color:#888888;">&nbsp;<?php echo $trpi ?>%</td></tr></table></center></div></td>
							<?php } else { ?>
							<td><div><center><table cellpadding="0" cellspacing="0" style="background-color:;border-collapse: collapse;"><tr width="35px"><td style="font-size:7.5pt;color:#FF0000;"><?php echo $Uptime_pct ?>%&nbsp;</td><td nowrap style="border:0px solid #aaaaaa;"><img src="<?php echo base_url(); ?>images/barchtgreen.gif" width="<?php echo $UptimeWidth ?>" height="12"></td><td style="font-size:7.5pt;color:#888888;">&nbsp;<?php echo $trpi ?>%</td></tr></table></center></div></td>
							<?php } ?>
							<td><?php echo anchor ('contentcontroller/qap3_SIQ_Number_update?ssiq='.$row->siquptime_no,''.$row->siquptime_no.'' ) ?></td>
						</tr>
						<?php $numrow++ ?>
						<?php endforeach;?>
						</tr>
