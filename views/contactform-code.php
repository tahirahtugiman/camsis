...
<div id='fg_formContainer'>
    <div id="fg_container_header">
        ...
        <div id="fg_box_Close"><a href=><label class="login-field-icon" style="padding-left:60px;"><span align="center" class="icon-cancel-circle"></label></a></div>
    </div>
    ...
    <form id='contactus'>
		<div align="center">
            <div class="form-group">
         	...
         	<div class="form-group">
              <input type="password" class="form-control login-field" value="" placeholder="Old Password" name="opassword" size="35"/>
