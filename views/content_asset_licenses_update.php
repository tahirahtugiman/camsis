...
<div class="ui-middle-screen">
	<div class="content-workorder" align="center">
		...
		<table class="ui-desk-style-table3" cellpadding="4" cellspacing="0" width="80%">	
			...
			<tr id="tester"style="display:<?php if ($lic[0]->v_IdentificationType == 'Personnel') { echo "none" ;}?>"><td colspan="3" class="ui-bottom-border-color" style="font-weight: bold;">License Representative</td></tr>			
			<tr id="tester1" style="display:<?php if ($lic[0]->v_IdentificationType == 'Personnel') { echo "none" ;}?>">
			...
			<tr id="loc1" style="display: <?php if ($lic[0]->v_IdentificationType == 'Personnel') { echo "" ;} else{ echo "none" ;}?>">
			<td colspan="3" class="ui-bottom-border-color" style="font-weight: bold;">Location</td>
			</tr>
			<tr id="loc2" style="display: <?php if ($lic[0]->v_IdentificationType == 'Personnel') { echo "" ;} else{ echo "none" ;}?>">
			...
			<tr id="loc3" style="display: <?php if ($lic[0]->v_IdentificationType == 'Personnel') { echo "" ;} else{ echo "none" ;}?>">
			...
			<tr id="loc4" style="display: <?php if ($lic[0]->v_IdentificationType == 'Personnel') { echo "" ;} else{ echo "none" ;}?>">
			...
			<tr id="loc5" style="display: <?php if ($lic[0]->v_IdentificationType == 'Personnel') { echo "" ;} else{ echo "none" ;}?>">
			<td class="td-assest">&nbsp; </td>
