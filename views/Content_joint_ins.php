...
<div class="menu" style="position:relative;">
	...
	<?php } ?>
		...
		<table class="tftable" border="1" style="text-align:center; width:70%;" align="center">
			...
			<tr>
				<th style="position: sticky;top: 22px;">Floors</th>
				<th style="position: sticky;top: 22px;">Walls/ door</th>
				<th style="position: sticky;top: 22px;">Ceiling</th>
				<th style="position: sticky;top: 22px;">Windows</th>
				<th style="position: sticky;top: 22px;">Fixtures</th>
				<th style="position: sticky;top: 22px;">Furniture &amp; Fitting</th>
			</tr>
			<?php if ($record) { ?>
