...
<body class="body-screen">
	...
	<div class="ui-left-screen">
		...
		<div align="center" class="color_style_1" style="font-weight:bold; margin-top:; font-size:25px; padding-top:15px; padding-bottom:15px; color:black;"><span><?php echo $this->session->userdata('usersess');?></span>
		    </div>
