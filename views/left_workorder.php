...
<body class="body-screen">
	...
	<div class="ui-left-screen">
		...
		<span style="float:; padding-right:10px;"><?php echo anchor ('contentcontroller/print_workorder', '<button class="btn-button btn-primary-button" style="width:100%; height:33px;">Print This Work Order <span class="icon-printer" style="float:right; margin-top:-4px; margin-right:20px; font-size:30px;"></span></button>');?></span>
		<div style="height:2px;"></div>
		<span style="float:; padding-right:10px;"><?php echo anchor ('contentcontroller/print_wos', '<button class="btn-button btn-primary-button" style="width:100%; height:33px;">Print Work Order Status <span class="icon-printer" style="float:right; margin-top:-4px; margin-right:20px; font-size:30px;"></span></button>');?></span>
