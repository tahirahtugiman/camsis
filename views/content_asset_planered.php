...
if ($this->input->get('ex') == 'excel'){
	...
	if( isset($_REQUEST['fic']) && $_REQUEST['fic']=='M' ){
		...
		$facility_group = 'CIVIL';
	}elseif ( isset($_REQUEST['fic']) && $_REQUEST['fic']=='E' ) {
		$facility_group = 'ELECTRICAL';
	}
	$filename = $facility_group." PPM PLANNER " .$year.".xls";
							...
							<tr class="ui-color-contents-style-1" height="30px">
								<td class="ui-header-new">
									...
									<span class="textmenu1" style="float:right;padding-top:<?=$mar?>px;?>">
										...
										<a href="<?php echo base_url();?>index.php/ppm_planered?ex=excel&y=<?=$year;?>&fic=<?=$this->input->post('fic');?>" style="float:right; margin-right:40px;">
							...
							<tr>
								<td class="ui-desk-style-table">
									<table class="ui-content-middle-menu-workorder2 ui-left_web" width="100%" border="0">
										...
										<tr class="ui-menu-color-header" style="color:white; background: #79B6D8;" align="center">
											<td>Asset No</td>
											<td>Asset Name</td>
											<td>Department Name</td>
											<td>Freq</td>
											<td width="8.33%" style="padding-top:3px; padding-bottom:3px; background: #398074;" class="ui-content-menu-desk-color">MONTH</td>
										...
										<tr class="" style="color:black; font-size:10px; background:white;" align="center">
											...
											<td width="8.33%" style="padding-top:3px; padding-bottom:3px; color:white; background: #398074;" class="ui-content-menu-desk-color">WEEK</td>
