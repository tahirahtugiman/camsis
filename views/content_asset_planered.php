				...
				<div class="middle_d2">
					<table width="100%" class="ui-content-form-reg" style="">
						<tr class="ui-color-contents-style-1" height="30px">
							...
							<a href="<?php echo base_url();?>index.php/contentcontroller/ppm_planer_export?act=exp&y=<?=$year?>" style="float:right; margin-right:40px;"><img src="<?php echo base_url();?>images/excel.png" style="width:30px; height:28px; position:absolute;" title="export to excel"></a>
							</span>
						...
						<tr >
							...
							<table class="ui-content-form" id="no-more-tables" width="100%" border="0">
								<tr style="background:#B3130A;">
									<td colspan="57" height="40px">
										<table width="100%" class="ui-content-middle-menu-desk">
											<tr style="background:#B3130A;">
												<td width="3%" height="30px">
												<a href="?y=<?= $year-1?>"><img src="<?php echo base_url(); ?>images/arrow-left2.png" alt="" class="ui-img-icon" style="padding-top:4px; padding-left:4px;"/></a>
												</td>
												<td width="88%" align="center">
												<?=$year?>
												</td>
												<td width="3%">
												<a href="?y=<?= $year+1?>"><img src="<?php echo base_url(); ?>images/arrow-right2.png" alt="" class="ui-img-icon" style="padding-top:4px; padding-left:4px;"/></a>
												</td>
											</tr>
										</table>
									</td>
								...
								<tr class="ui-menu-color-header" style="color:white; font-size:10px;" align="center">
									<td>Asset No</td>
									<td>Asset Name</td>
