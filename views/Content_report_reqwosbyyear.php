...
$filename ="Work Order Report Summary by Year".date('F', mktime(0, 0, 0, $month, 10)) .$year.".xls";
...
<?php if (($this->input->get('ex') == '') or ($this->input->get('none') == 'closed')){?>
	<table width="99%" border="0">
		...
		<tr>
			<td width="50%">Work Order Report Summary By Year <?=$year?><br><i>Computer Generated - CAMSIS</i></td>
