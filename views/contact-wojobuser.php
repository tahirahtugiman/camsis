...
<div id='fg_formContainer'>
    ...
    <div align="center">
          ...
          <div class="form-group">
            ...
            <input type="submit" class="btn btn-primary btn-lg btn-block" name="mysubmit" onclick="javascript: form.action='<?php echo base_url(); ?>index.php/userverification_ctrl/wojobclose_verification';" value="Submit" /></td>
