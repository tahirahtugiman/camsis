	...
	<div class="content-workorder" align="center">
		...
		<table class="ui-desk-style-table3" cellpadding="4" cellspacing="0" width="92%">	
			<tr class="ui-color-contents-style-1" height="40px">
				<td class="ui-header-new" colspan="2"><b>Update Visit One</b></td>
                        <span style="color:red;"><?php echo validation_errors(); ?>
			</tr>
			<tr>
				<td valign="top" class="td-assest">Visit Date : </td>
				<td ><input type="date" name="n_Visit_Date" value="<?php echo set_value('n_Visit_Date',isset($record[0]->d_Date) == TRUE ? date_format(new DateTime($record[0]->d_Date), 'Y-m-d') : date_format(new DateTime($recordresp[0]->d_Date), 'Y-m-d'))?>" class="form-control-button2 n_wi-date"></td>
			</tr>
			<tr>
				...
				<td>
					<?php 
										...
										'0' => '0',
										 ...
										 ?>
								        <?php echo form_dropdown('n_Shour', $hour_list, set_value('n_Shour',isset($Stime[0]) == TRUE ? $Stime[0] : $Stimeres[0]) , 'class="dropdown" style="width: 52px;" id="Stime_h"'); ?> 
										<?php 
										$min_list = array(
										'0' => '0',
                  						'1' => '1',
										 ...
										 ?>		
		              			<?php echo form_dropdown('n_Smin', $min_list, set_value('n_Smin',isset($Stime[1]) == TRUE ? $Stime[1] : $Stimeres[1]) , 'class="dropdown" style="width: 52px;" id="Stime_m"'); ?>
				</td></td>
			</tr>
			<tr>
