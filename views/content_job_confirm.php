	...
	<div class="content-workorder" align="center">
		<table class="ui-desk-style-table3" cellpadding="4" cellspacing="0" width="80%">	
			...
			<tr>
				...
				<td ><?= isset($d_date[0]) == TRUE ? date_format(new DateTime($d_date), 'd-m-Y H:i') : 'N/A'?></td>
			</tr>
			<tr>
			...
			<tr>
				<td class="td-assest">Job Close Time :</td>
				<td>
					<?php 
										$hour_list = array(
										'0' => '0',
...
<script language="javascript" type="text/javascript">
	...
	{
		if (document.getElementById('fJStoppage').checked == true) 
			{
