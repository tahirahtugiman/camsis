	...
	<div class="scrolltable<?=($this->input->get('none') == 'closed') ? '' : '1';?>">
		<table class="header-alr">
			...
			<tbody class="asst">
				...
				<?php }else { ?>
			<tbody class="tbl-fixed-td-bes">
				<tr align="center" style="background:white; height:310px;">
					<td colspan="26"><span style="color:red; display:block;">NO COMPLAINT RECORDS FOUND FOR THIS WORK ORDER.</span></td>
				</tr>
			</tbody>
				<?php } ?>
		</table>
