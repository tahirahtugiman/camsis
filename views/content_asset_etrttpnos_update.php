	...
	<div class="content-workorder" align="center">
		...
		<table class="ui-desk-style-table3" cellpadding="4" cellspacing="0" width="80%">	
			<tr class="ui-color-contents-style-1" height="40px">
				<td class="ui-header-new" colspan="6"><b>Update Reminder To Third Party / Notification Of Status</b></td>
			</tr>
			<tr>
				<td class="p-left" colspan="4" style="padding-top:20px; padding-bottom:20px;">
					<table class="wnctable" border="1" style="text-align:center;" align="center">
						...
						<tr>
							...
							<td><input type="date" name="n_Equipment_Name " value="" class="form-control-button2" ></td>
							<td><textarea class="Input" name="n_Please_specity"  cols="22" rows="3"></textarea></td>
			...
			<tr class="ui-header-new" style="height:40px;">
				<td align="center" colspan="6" style="border-bottom-left-radius:5px; border-bottom-right-radius:5px;">
					<?php echo anchor ('contentcontroller/assetetrttpnos_confirm', '<button type="button" class="btn-button btn-primary-button" style="width:200px;">Save</button>'); ?>
