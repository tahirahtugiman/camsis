							...
							<td class="ui-desk-style-table">
								<table class="ui-content-form" width="100%" border="0">
									<tr>
										...
										<td valign="top">
											<input type="text" id="n_Checklist_Code" name="n_Checklist_Code" value="" class="form-control-button2 n_wi-date2" disabled>
										</td>
									</tr>
									<tr>
										<td style="padding-left:10px;" valign="top"></td>
									...
									<tr>
										...
										<td valign="top">
											<input type="text" id="n_Procedure_Code" name="n_Procedure_Code" value="" class="form-control-button2 n_wi-date2" disabled>
										</td>
									</tr>
									<tr>
										<td style="padding-left:10px;" valign="top"></td>
