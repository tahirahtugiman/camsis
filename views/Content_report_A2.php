...
$filename ="A2 Listing Scheduled (".date('F', mktime(0, 0, 0, $month, 10)).")".$year.".xls";
...
<div id="Instruction" class="pr-printer">
    <div class="header-pr">A2 Listing Scheduled</div>
...
<?php if (($this->input->get('ex') == '') or (1==0)){?>
	<table width="99%" border="0">
		...
		<tr>
			<td width="50%"> A2 Listing Work Order - Scheduled - <?= date("F-Y")?><br><!--<i>Computer Generated - APBESys</i>--></td>
...
<?php if (($this->input->get('ex') == '') or ($this->input->get('none') == 'closed')){?>
	<table width="99%" border="0">
		...
		<tr>
			<td width="50%">A2 Listing Work Order Status Report<br><i>Computer Generated - CAMSIS</i></td>
			<td width="50%" align="right"></td>
		</tr>
	</table>
