	...
	<div class="content-workorder">
		<table class="ui-content-middle-menu-workorder" border="0" height="" width="80%" align="center">
			...
			<tr class="" height="40px" style="color:white;">
				<td class="ui-middle-color assets-headear" colspan="3" style="padding-left:10px;">
					<b>Asset With No SIQ <?=date('F', mktime(0, 0, 0, $month, 10))?> <?=$year?></b><br />
					<span style="font-size:14px;"><i>The following assets were evaluated for SIQ but no shortfall in quality found.</i></span>
				</td>
			</tr>
				...
				<td colspan="12" height="40px">
					<table width="100%" class="ui-content-middle-menu-desk">
						<tr>
							...
							<td width="3%">
								<a href="?y=<?= ($month+1 == 13) ? $year+1 :$year?>&m=<?= ($month+1 == 13) ? 1 :$month+1?>&tab=1&asst=1">
						...
						<table class="ui-desk-style-table" style="color:black; background:white; text-align:center;" cellpadding="4" cellspacing="0" width="100%">      			
							...
							<?= $numrow%2==0 ? '<tr class="ui-color-color-color item" id="item-<?php echo $numrow?>">' : '<tr class="item" id="item-<?php echo $numrow?>">'; ?>
								...
								<td>
									<div>
										<center>
											<table cellpadding="0" cellspacing="0" style="background-color:;border-collapse: collapse;">
												<tr width="35">
													<td style="font-size:7.5pt;color:#FF0000;"><?php echo $Uptime_pct ?>%&nbsp;</td>
													<td nowrap width="<?php echo $BarWidth ?>" style="border:0px solid #aaaaaa;">
														<img src="<?php echo base_url(); ?>images/barchtpink.gif" width="<?php echo $UptimeWidth ?>" height="12">
														<img src="<?php echo base_url(); ?>images/barchtgrey.gif" width="<?php echo $TargetWidth ?>" height="12">
													</td>
													<td style="font-size:7.5pt;color:#888888;">&nbsp;<?php echo $trpi ?>%</td>
												</tr>
											</table>
										</center>
									</div>
										...
										<center>
											<table cellpadding="0" cellspacing="0" style="background-color:;border-collapse: collapse;">
												<tr width="35">
													<td style="font-size:7.5pt;color:#FF0000;"><?php echo $Uptime_pct ?>%&nbsp;</td>
													<td nowrap width="<?php echo $BarWidth ?>" style="border:0px solid #aaaaaa;">
														<img src="<?php echo base_url(); ?>images/barchtgreen.gif" width="<?php echo $UptimeWidth ?>" height="12">
													</td>
													<td style="font-size:7.5pt;color:#888888;">&nbsp;<?php echo $trpi ?>%</td>
												</tr>
											</table>
