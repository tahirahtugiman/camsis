...
<html>
	...
	<body>
		<div class="wrapper">
				...
				<tr>
					<td width="60%"><div class="info-po"><?=(isset($veninfo[0]->VENDOR_NAME)) ? $veninfo[0]->VENDOR_NAME : ''?>
						<table style="padding:5x;" width="100%" border="0" class="tbl-info-po">
							...
							<tr>
								<td>ATTN : </td>
								<td><?=(isset($veninfo[0]->CONTACT_PERSON)) ? $veninfo[0]->CONTACT_PERSON : ''?></td>
							</tr>
							<tr>
								<td></td>
							</tr>
					...
					<td width="40%" ><div class="info-pr" style="margin-top: 10px; padding-top: 10px;" valign="top">
						<br><br><br><br><br><br><br>
						<table border="0" class="" valign="top">
							<tr>
			...
			<table class="tbl-info-detail" style="margin-top: 0px; padding-top: 0px;">
				<tr>
					<td class="bold"></td>
				...
				<tr>
					<td class="tbl-info-td">EQUIPMENT NAME : <?=(isset($record[0]->V_Asset_name)) ? $record[0]->V_Asset_name :''?></td>
			...
			<table class="tbl-info-invoice">
				...
				<tr nobr="true">
					<td colspan="6" style="text-align:left; padding-left:5px; text-transform: none; height:20px;"><i>Please notify us immediately (refer PO acceptance form) if this order cannot</i><br /><i>be shipped or completed on or before 7 days from the last date of signatory</i></td>
			...
			<table  border="0" class="tbl-info-tc">
				...
				<tr>
					...
					<td width="70%"><i>As human health care provider, the repaired, supplied devices and services carried out, <br /> must comply to Occupational Health and Safety (OHS) Standard and Environmental <br /> Quality Act 1974(EQA).</i></td>
					<td width="20%">Authorised Signatory :</td>
				</tr>
				<tr>
					<td valign="top"><i>ii)</i></td>
					<td><i>The supplier shall notify Advance Pact Sdn Bhd of changes in the purchased product prior to implementation <br> of any changs that effect the ability of the purchased product to meet specified purchase requirements.</i></td>
					<td></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><i>Invoice together with job sheet/service report/delivery order shall be sent to : <br /> <span style="font-weight:normal; display:block;">HEAD OFFICE : 2-3A, Perdana The Place, Jalan PJU 8/5G,</span></i> <br/><span style="font-weight:normal; display:block;"> Bandar Damansara Perdana , 47820 Petaling Jaya, Selangor </span></td>
					<td></td>
				</tr>
				<tr>
					<td valign="top"><i>v)</i></td>
					<td><i>Payment terms:-</i> [] <i>Cash on delivery</i> [] <i>Cash in Advance</i> [] <i>30 Days from invoice date</i></td>
					<td></td>
				</tr>
				<tr>
				...
				<br><br>
				<tr>
					<td class="tc-address" colspan="3">HEAD OFFICE : 2-3A, Perdana The Place, Jalan PJU 8/5G, Bandar Damansara Perdana , 47820 Petaling Jaya, Selangor Darul Ehsan Malaysia <br /> Tel :+6(03)-7726 8632 &nbsp;&nbsp;&nbsp; Fax :+6(03)-7728 3075</td>
				</tr>
				<tr>
					<td colspan="2">APSB-FORM</td>
					<td align="right">Revision 6.0 : 04 October 2018</td>
				</tr>
