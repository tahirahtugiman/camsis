<?php echo form_open('contentcontroller/visittwo_update?wrk_ord='.$this->input->get('wrk_ord'));?>
<div class="ui-middle-screen">
	<div class="content-workorder" align="center">
				...
				<td class="pd-bttm" colspan="11" valign="top">
					<table width="98%" class="ui-content-middle-menu-workorder" style="">
						<tr class="ui-color-contents-style-1" height="30px">
							...
							<td colspan="2" class="ui-header-new" valign="top"><span style="float: left; margin-top:8px; font-weight: bold;">Visit Two</span><span style="color:red; float: left; font-size: 14px; margin-top:8px; margin-left:8px;">You may not update this section until you have filled in Visit 1 information.</span>&nbsp;<span style="float: right; padding-right:10px;"><input type="submit" class="btn-button btn-primary-button" style="width: 100px;" name="mysubmit" value="Update" disabled></span></td>
							<?php }	?>
							<?php if (isset($recordcheck[0]->v_WrkOrdNo) == TRUE) { ?>
							<td colspan="2" class="ui-header-new" valign="top"><span style="float: left; margin-top:8px; font-weight: bold;">Visit Two</span>&nbsp;<span style="float: right; padding-right:10px;"><input type="submit" class="btn-button btn-primary-button" style="width: 100px;" name="mysubmit" value="Update"></span></td>
							<?php }	?>					
						</tr>
						<tr >
		...
		<?php  echo form_hidden('wo',$this->input->get('wo')); ?>
	</div>
</div>
<?php echo form_close(); ?>