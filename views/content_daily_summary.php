...
<div class="menu" style="position:relative;">
	...
	<?php if($this->input->get('en') == 'cls'){ ?>
		...
		<table width="98%" class="ui-content-middle-htd">
			<tr class="ui-color-contents-style-1" height="40px">
				<td colspan="2" class="ui-header-new"><span style="float: left; font-weight: bold;">Daily Cleaning Activity Summary <?=date('F', mktime(0, 0, 0, $fmonth, 10))?> <?=$fyear ?></span></td>
			</tr>
			<tr >
				<td class="ui-desk-style-table">
	...
	<?php }elseif($this->input->get('en') == 'clshosp'){ ?>
		...
		<table width="98%" class="ui-content-middle-htd">
			<tr class="ui-color-contents-style-1" height="40px">
				<td colspan="2" class="ui-header-new"><span style="float: left; font-weight: bold;">Cleansing Summary Report for Hospital : <?=isset($hosp) ? $hosp : ''?> <?=date('F', mktime(0, 0, 0, $fmonth, 10))?> <?=$fyear ?></span></td>
			</tr>
			<tr >
				<td class="ui-desk-style-table">
					<div id="constrainer" style="height: 55%;">
	...
	<?php }elseif($this->input->get('en') == 'clsdate'){ ?>
		...
		<table width="98%" class="ui-content-middle-htd">
			<tr class="ui-color-contents-style-1" height="40px">
				<td colspan="2" class="ui-header-new"><span style="float: left; font-weight: bold;">Daily Cleaning Activity Detail for Hospital : <?=isset($hosp) ? $hosp : ''?> >> <?=isset($dept) ? $dept : ''?> <?=date('F', mktime(0, 0, 0, $fmonth, 10))?> <?=$fyear ?></span></td>
			</tr>
			<tr >
				<td class="ui-desk-style-table">
					<div id="constrainer" style="height: 55%;">
	...
	<?php }elseif($this->input->get('en') == 'clsmon'){ ?>
		...
		<table width="98%" class="ui-content-middle-htd">
			<tr class="ui-color-contents-style-1" height="40px">
				<td colspan="2" class="ui-header-new"><span style="float: left; font-weight: bold;">Cleansing Summary Report for Month : Jan</span></td>
			</tr>
			<tr >
				<td class="ui-desk-style-table">
					<div id="constrainer" style="height: 55%;">
	...
	<?php }elseif($this->input->get('en') == 'clsmondate'){ ?>
		...
		<table width="98%" class="ui-content-middle-htd">
			<tr class="ui-color-contents-style-1" height="40px">
				<td colspan="2" class="ui-header-new"><span style="float: left; font-weight: bold;">Cleansing Summary Report for date : 22 jan 2015</span></td>
			</tr>
			<tr >
				<td class="ui-desk-style-table">
					<div id="constrainer" style="height: 55%;">
