...
switch ($tabber) {
    ...
    case "6":
		...
		$right = base_url().'index.php/contentcontroller/assetlogcards?asstno='.$this->input->get('asstno').'&tab=8';
        break;
    case "7":
    ...
    case "9":
        $tulis = "Print<br />Form";
		$tulis1 = "Print Form";
		$left = base_url().'index.php/contentcontroller/assetlogcards?asstno='.$this->input->get('asstno').'&tab=8';
		$right = base_url().'index.php/contentcontroller/assetet?asstno='.$this->input->get('asstno').'&tab=10&parent=assets';
        break;
	case "10":
        $tulis = "Fail<br />Bank";
		$tulis1 = "Fail Bank";
		$left = base_url().'index.php/contentcontroller/assetwn?asstno='.$this->input->get('asstno').'&tab=9&pf=1&parent=assets';
		$right = base_url().'index.php/contentcontroller/assetwe?asstno='.$this->input->get('asstno').'&tab=11&parent=assets';
        break;
    case "11":
        $tulis = "Warranty<br />Expiry";
		$tulis1 = "Warranty Expiry";
		$left = base_url().'index.php/contentcontroller/assetet?asstno='.$this->input->get('asstno').'&tab=10&parent=assets';
		$right = base_url().'index.php/contentcontroller/assetwf?asstno='.$this->input->get('asstno').'&tab=12&parent=assets';
        break;
	case "12":
