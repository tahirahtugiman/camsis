								...
								<table class="ui-content-form" width="100%" border="0">
									<tr>
										...
										<td>
											...
											<?php echo form_dropdown('n_team', $Team_list, set_value('n_team') , 'class="dropdown n_wi-date2"'); ?>
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td><?php $QAP_list = array(
											...
											<?php echo form_dropdown('n_qap', $QAP_list, set_value('n_qap') , 'class="dropdown n_wi-date2"'); ?>
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td>
											<?php $Active_list = array(
														'0' => 'Y',
														'1' => 'N',
													 ); ?>
											<?php echo form_dropdown('n_a_Status', $Active_list, set_value('n_a_Status') , 'class="dropdown n_wi-date2"'); ?>
										</td>
									</tr>
									<tr>
