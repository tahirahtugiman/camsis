	...
	<div class="content-workorder" align="center">
		...
		<table class="ui-desk-style-table3" cellpadding="4" cellspacing="0" width="80%">	
			<tr class="ui-color-contents-style-1" height="40px">
				<td class="ui-header-new" colspan="2"><b>Confirm List of Detect</b></td>
			</tr>
			<tr>
				...
				<td class="p-left" colspan="4" style="padding-top:20px; padding-bottom:20px;">
					<table class="wnctable" border="1" style="text-align:center;" align="center">
						...
						<tr>
							...
							<td colspan="" style="" valign="top" height="25px" align="left">: <input type="text" name="n_model" value="" class="form-control-button2" disabled></td>
							<td colspan="" style="width:15%;" valign="top" height="25px" align="right">Signature </td>
							<td colspan="" style="" valign="top" height="25px" align="left">: <input type="text" name="n_model" value="" class="form-control-button2" disabled></td>
						</tr>
						<tr>
			...
			<tr class="ui-header-new" style="height:40px;">
				<td align="center" colspan="2">
					<?php echo anchor ('contentcontroller/assetwflod_confirm', '<button type="button" class="btn-button btn-primary-button" style="width:200px;">Confirm</button>'); ?>
