	...
	<div class="content-workorder" align="center">
		...
		<table class="ui-desk-style-table3" cellpadding="4" cellspacing="0" width="92%">	
			<tr class="ui-color-contents-style-1" height="40px">
				<td class="ui-header-new" colspan="2"><b>Update Visit Two</b></td>
                        <span style="color:red;"><?php echo validation_errors(); ?>
			</tr>
			<tr>
                        <td valign="top" class="td-assest">Visit Date : </td>
                        <td ><input type="date" name="n_Visit_Date" value="<?php echo set_value('n_Visit_Date',isset($record[0]->d_Date) == TRUE ? date_format(new DateTime($record[0]->d_Date), 'Y-m-d') : 'N/A')?>" class="form-control-button2 n_wi-date"></td>
                  </tr>
                  <tr>
