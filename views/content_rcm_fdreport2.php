...
<div id="Instruction" class="pr-printer">
    ...
    <button onclick="javascript:myFunction('rcm_fdreport2?jobdate=<?=$this->input->get('jobdate')?>&ex=&stat=<?=$this->input->get('stat');?>&grp=<?=$this->input->get('grp');?>&wid=1&req=<?=$this->input->get('req');?>&broughtfwd=<?=$this->input->get('broughtfwd')?>&serv=<?=$this->input->get('serv')?>&x=<?=$this->input->get('x')?>');" class="btn-button btn-primary-button">PRINT</button>
