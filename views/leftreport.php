...
<!-- Header -->
			...
			<div id="content">
	        	<nav id="nav">
					...
					<ul>
						...
						<li><?php echo anchor('contentcontroller/ttassetrequiment?&parent=AssetSummary&tab=16', 'Total asset by legal requirement',($this->input->get('tab') == '16') ?array('id' => 'active'):'');?></li>
				...
				<?php }elseif ($this->input->get('parent') == 'ScheduledWorkOrderReport' ){?>
					<ul>
						<li><?php echo anchor('contentcontroller/ttrctimeframe?&parent=ScheduledWorkOrderReport&tab=0&', 'Total of request competed by time frame',($this->input->get('tab') == '0') ?array('id' => 'active'):'');?></li>
	...
	<div id="main">
		...
		<section id="top">
			<div class="container">
				<?php if ($this->input->get('parent') == 'AssetSummary' ){?>
				<div class="header-container"><h1>Asset Summary Listing</h1></div>
				<?php }elseif ($this->input->get('parent') == 'ServiceRequest' ){?>
				<div class="header-container"><h1>Service Request</h1></div>
				<?php }elseif ($this->input->get('parent') == 'UnscheduledReport' ){?>
				<div class="header-container"><h1>Unscheduled Report</h1></div>
				<?php }elseif ($this->input->get('parent') == 'ScheduledWorkOrderReport' ){?>
				<div class="header-container"><h1>Scheduled Work Order Report</h1></div>
				<?php }?>
				<?php if ($this->input->get('parent') == 'AssetSummary' ){?>
					<?php if ($this->input->get('tab') == 0){?>
						<div class="header-container-print"><h1>Total of asset by asset type</h1></div>
					<?php }elseif ($this->input->get('tab') == 1){?>
						<div class="header-container-print"><h1>Total asset by model</h1></div>
					<?php }elseif ($this->input->get('tab') == 2){?>
						<div class="header-container-print"><h1>Total asset by manufacturer</h1></div>
					<?php }elseif ($this->input->get('tab') == 3){?>
						<div class="header-container-print"><h1>Total of purchase cost by asset type</h1></div>
					<?php }elseif ($this->input->get('tab') == 4){?>
						<div class="header-container-print"><h1>Total of purchase cost by model</h1></div>
					<?php }elseif ($this->input->get('tab') == 5){?>
						<div class="header-container-print"><h1>Total of purchase cost by manufacturer</h1></div>
					<?php }elseif ($this->input->get('tab') == 6){?>
						<div class="header-container-print"><h1>Total asset by department</h1></div>
					<?php }elseif ($this->input->get('tab') == 7){?>
						<div class="header-container-print"><h1>Total asset by group asset</h1></div>
					<?php }elseif ($this->input->get('tab') == 8){?>
						<div class="header-container-print"><h1>Total asset by year purchase</h1></div>
					<?php }elseif ($this->input->get('tab') == 9){?>
						<div class="header-container-print"><h1>Total asset by location</h1></div>
					<?php }elseif ($this->input->get('tab') == 10){?>
						<div class="header-container-print"><h1>Total asset by asset status</h1></div>
					<?php }elseif ($this->input->get('tab') == 11){?>
						<div class="header-container-print"><h1>Total asset by asset condition</h1></div>
					<?php }elseif ($this->input->get('tab') == 12){?>
						<div class="header-container-print"><h1>Total asset by asset variation</h1></div>
					<?php }elseif ($this->input->get('tab') == 13){?>
						<div class="header-container-print"><h1>Total asset by still in warranty</h1></div>
					<?php }elseif ($this->input->get('tab') == 14){?>
						<div class="header-container-print"><h1>Total asset by exceed warranty</h1></div>
					<?php }elseif ($this->input->get('tab') == 15){?>
						<div class="header-container-print"><h1>Total asset by aging</h1></div>
					<?php }elseif ($this->input->get('tab') == 16){?>
						<div class="header-container-print"><h1>Total asset by legal requirement</h1></div>
					<?php }elseif ($this->input->get('tab') == 17){?>
						<div class="header-container-print"><h1>Cumulative part cost</h1></div>
					<?php }elseif ($this->input->get('tab') == 18){?>
						<div class="header-container-print"><h1>Cumulative labor cost</h1></div>
					<?php }?>
				<?php }elseif ($this->input->get('parent') == 'ServiceRequest' ){?>
					<?php if ($this->input->get('tab') == 0){?>
						<div class="header-container-print"><h1>Total of request responded late</h1></div>
					<?php }elseif ($this->input->get('tab') == 1){?>
						<div class="header-container-print"><h1>Total of request responded on time</h1></div>
					<?php }elseif ($this->input->get('tab') == 2){?>
						<div class="header-container-print"><h1>Total of request by department</h1></div>
					<?php }elseif ($this->input->get('tab') == 3){?>
						<div class="header-container-print"><h1>Total of request by aging</h1></div>
					<?php }elseif ($this->input->get('tab') == 4){?>
						<div class="header-container-print"><h1>Responded by technical</h1></div>
					<?php }?>
				<?php }elseif ($this->input->get('parent') == 'UnscheduledReport' ){?>
					<?php if ($this->input->get('tab') == 0){?>
						<div class="header-container-print"><h1>Total of request completed by time frame</h1></div>
					<?php }elseif ($this->input->get('tab') == 1){?>
						<div class="header-container-print"><h1>Total of request outstanding by time frame</h1></div>
					<?php }elseif ($this->input->get('tab') == 2){?>
						<div class="header-container-print"><h1>Total of request by asset type/model/manufacturer</h1></div>
					<?php }elseif ($this->input->get('tab') == 3){?>
						<div class="header-container-print"><h1>Total of request by location/department</h1></div>
					<?php }elseif ($this->input->get('tab') == 4){?>
						<div class="header-container-print"><h1>Total of request by asset status/condition/variation</h1></div>
					<?php }elseif ($this->input->get('tab') == 5){?>
						<div class="header-container-print"><h1>Completed by technical/staff efficiency</h1></div>
					<?php }?>
				<?php }elseif ($this->input->get('parent') == 'ScheduledWorkOrderReport' ){?>
					<?php if ($this->input->get('tab') == 0){?>
						<div class="header-container-print"><h1>Total of request competed by time frame</h1></div>
					<?php }elseif ($this->input->get('tab') == 1){?>
						<div class="header-container-print"><h1>Total of request outstanding by time frame</h1></div>
					<?php }elseif ($this->input->get('tab') == 2){?>
						<div class="header-container-print"><h1>Total of request by discipline ( PPM / RI)</h1></div>
					<?php }elseif ($this->input->get('tab') == 3){?>
						<div class="header-container-print"><h1>Total of request by asset type/model/manufacturer</h1></div>
					<?php }elseif ($this->input->get('tab') == 4){?>
						<div class="header-container-print"><h1>Total of request by location/department</h1></div>
