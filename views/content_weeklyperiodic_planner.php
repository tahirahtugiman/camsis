		 ...
		 <tr class="greyii">
		  ...
		  <?php } ?>	
			<tr>
				...
				<td <?= isset($color['Monday'.$rows->v_UserDeptCode]) ? $color['Monday'.$rows->v_UserDeptCode] : '' ?> id='Monday<?=$rows->v_UserDeptCode?>' onclick="changeColor(this, 'Monday<?=$rows->v_UserDeptCode;?>', 'Monday', '<?=$rows->v_UserDeptCode;?>', '<?=$this->session->userdata('v_UserName');?>', '<?=$month.$year;?>','<?=isset($privilege[0]->user_priv) ? $privilege[0]->user_priv : "";?>')"><?= isset($day['Monday'.$rows->v_UserDeptCode]) ? $day['Monday'.$rows->v_UserDeptCode] : '' ?></td>
