		 ...
		 <tr class="greyii">
		  ...
		  <?php } ?>	
			<tr>
				...
				<td <?= isset($color['Monday'.$rows->v_UserDeptCode]) ? $color['Monday'.$rows->v_UserDeptCode] : '' ?> id='Monday<?=$rows->v_UserDeptCode?>' onclick="changeColor(this, 'Monday<?=$rows->v_UserDeptCode;?>', 'Monday', '<?=$rows->v_UserDeptCode;?>', '<?=$this->session->userdata('v_UserName');?>', '<?=$month.$year;?>','<?=isset($privilege[0]->user_priv) ? $privilege[0]->user_priv : 0;?>')"><?= isset($day['Monday'.$rows->v_UserDeptCode]) ? $day['Monday'.$rows->v_UserDeptCode] : '' ?></td>
				<td <?= isset($color['Tuesday'.$rows->v_UserDeptCode]) ? $color['Tuesday'.$rows->v_UserDeptCode] : '' ?> id='Tuesday<?=$rows->v_UserDeptCode?>' onclick="changeColor(this, 'Tuesday<?=$rows->v_UserDeptCode?>', 'Tuesday', '<?=$rows->v_UserDeptCode?>', '<?=$this->session->userdata('v_UserName');?>', '<?=$month.$year?>','<?=isset($privilege[0]->user_priv) ? $privilege[0]->user_priv : ""; ?>')"><?= isset($day['Tuesday'.$rows->v_UserDeptCode]) ? $day['Tuesday'.$rows->v_UserDeptCode] : '' ?></td>
				<td <?= isset($color['Wednesday'.$rows->v_UserDeptCode]) ? $color['Wednesday'.$rows->v_UserDeptCode] : '' ?> id='Wednesday<?=$rows->v_UserDeptCode?>' onclick="changeColor(this, 'Wednesday<?=$rows->v_UserDeptCode?>', 'Wednesday', '<?=$rows->v_UserDeptCode?>', '<?=$this->session->userdata('v_UserName');?>', '<?=$month.$year?>','<?=isset($privilege[0]->user_priv) ? $privilege[0]->user_priv : ""; ?>')"><?= isset($day['Wednesday'.$rows->v_UserDeptCode]) ? $day['Wednesday'.$rows->v_UserDeptCode] : '' ?></td>
				<td <?= isset($color['Thursday'.$rows->v_UserDeptCode]) ? $color['Thursday'.$rows->v_UserDeptCode] : '' ?> id='Thursday<?=$rows->v_UserDeptCode?>' onclick="changeColor(this, 'Thursday<?=$rows->v_UserDeptCode?>', 'Thursday', '<?=$rows->v_UserDeptCode?>', '<?=$this->session->userdata('v_UserName');?>', '<?=$month.$year?>','<?=isset($privilege[0]->user_priv) ? $privilege[0]->user_priv : "";?>')"><?= isset($day['Thursday'.$rows->v_UserDeptCode]) ? $day['Thursday'.$rows->v_UserDeptCode] : '' ?></td>
				<td <?= isset($color['Friday'.$rows->v_UserDeptCode]) ? $color['Friday'.$rows->v_UserDeptCode] : '' ?> id='Friday<?=$rows->v_UserDeptCode?>' onclick="changeColor(this, 'Friday<?=$rows->v_UserDeptCode?>', 'Friday', '<?=$rows->v_UserDeptCode?>', '<?=$this->session->userdata('v_UserName');?>', '<?=$month.$year?>','<?=isset($privilege[0]->user_priv) ? $privilege[0]->user_priv : ""; ?>')"><?= isset($day['Friday'.$rows->v_UserDeptCode]) ? $day['Friday'.$rows->v_UserDeptCode] : '' ?></td>
				<td <?= isset($color['Saturday'.$rows->v_UserDeptCode]) ? $color['Saturday'.$rows->v_UserDeptCode] : '' ?> id='Saturday<?=$rows->v_UserDeptCode?>' onclick="changeColor(this, 'Saturday<?=$rows->v_UserDeptCode?>', 'Saturday', '<?=$rows->v_UserDeptCode?>', '<?=$this->session->userdata('v_UserName');?>', '<?=$month.$year?>','<?=isset($privilege[0]->user_priv) ? $privilege[0]->user_priv : ""; ?>')"><?= isset($day['Saturday'.$rows->v_UserDeptCode]) ? $day['Saturday'.$rows->v_UserDeptCode] : '' ?></td>
				<td <?= isset($color['Sunday'.$rows->v_UserDeptCode]) ? $color['Sunday'.$rows->v_UserDeptCode] : '' ?> id='Sunday<?=$rows->v_UserDeptCode?>' onclick="changeColor(this, 'Sunday<?=$rows->v_UserDeptCode?>', 'Sunday', '<?=$rows->v_UserDeptCode?>', '<?=$this->session->userdata('v_UserName');?>', '<?=$month.$year?>','<?=isset($privilege[0]->user_priv) ? $privilege[0]->user_priv : ""; ?>')"><?= isset($day['Sunday'.$rows->v_UserDeptCode]) ? $day['Sunday'.$rows->v_UserDeptCode] : '' ?></td>
				<td></td>
			</tr>
			<?php $numrow++?>
