  ...
  <div class="content-workorder" align="center">
    ...
    <table class="ui-desk-style-table3" cellpadding="4" cellspacing="0" width="92%">  
      <tr class="ui-color-contents-style-1" height="40px">
        <td class="ui-header-new" colspan="2"><b>Update Visit Plus</b></td>
                        <span style="color:red;"><?php echo validation_errors(); ?>
      </tr>
      <tr>
        <td valign="top" class="td-assest">Visit Date : </td>
        <td ><input type="text" id="date<?php echo $numberdate++; ?>" name="n_Visit_Date" value="<?php echo set_value('n_Visit_Date', isset($record[0]->d_Date) == TRUE ? date_format(new DateTime($record[0]->d_Date), 'd-m-Y') : '')?>" class="form-control-button2"></td>
      </tr>
      <tr>
      ...
      <tr>
		...
		<tr><td colspan="3" class="closedwo"></td></tr>
    ...
    $('#closed').change(function() {
      ...
      $(".closedwo").show();
            $(".closedwo").load('<?php  if ($this->uri->slash_segment(1) == "contentcontroller/") {
                                      ...
                                      echo "../contentcontroller/visitjclosed";
                                      }
                                      else {
                                        echo "contentcontroller/visitjclosed";
