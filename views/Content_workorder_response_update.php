<?php echo form_open('wo_response_update_ctrl');?>
<?php $numberdate = 0; ?>
<div class="ui-middle-screen">
      <div class="div-p"></div>
	<div class="content-workorder" align="center">
		<table class="ui-desk-style-table3" style="color:black;" cellpadding="4" cellspacing="0" width="92%">	
			<tr class="ui-color-contents-style-1" height="40px">
				<td class="ui-header-new" colspan="2"><b>Update Response</b></span></td>
			...
			<tr>
				<td class="td-assest">Priority :</td>
				...
				<td><?= isset($disp[0]->V_priority_code) == TRUE ? $disp[0]->V_priority_code : 'N/A'?> <span style="color:red;">REQUEST MUST BE RESPONDED NOW.</span></td>
				<?php } ?>
				<?php } ?>
			</tr>
			...
			<tr>
				...
				<td><input type="text"  id="date<?php echo $numberdate++; ?>" name="n_Response_Date" value="<?php echo set_value('n_Response_Date', isset($record[0]->d_Date) == TRUE ? date_format(new DateTime($record[0]->d_Date), 'd-m-Y') : date_format(new DateTime($datetimereq[0]), 'Y-m-d'))?>" class="form-control-button2"></td>
			</tr>
			<tr>
				...
				<td>
					<?php 
										...
										'0' => '0',
										 ...
										 ?>
								        <?php echo form_dropdown('n_Shour', $hour_list, set_value('n_Shour',isset($Stime[0]) == TRUE ? $Stime[0] : $timereq[0]) , 'class="dropdown" style="width: 52px;" id="Stime_h"'); ?> 
										<?php 
										$min_list = array(
										'0' => '0',
                  						'1' => '1',
										 ...
										 ?>		
		              			<?php echo form_dropdown('n_Smin', $min_list, set_value('n_Smin',isset($Stime[1]) == TRUE ? $Stime[1] : $timereq[1]) , 'class="dropdown" style="width: 52px;" id="Stime_m"'); ?>
				</td>
			</tr>
			<tr>
...
echo anchor_popup('contentcontroller/pop_vendor?parent=woresponse', '<span class="icon-windows"></span>', $atts);?> 
                              ...
                              <div class="p-vo-3"><span class="ui-left_mobile">RM : </span><input type="text" id="V_reqRM" name="V_reqRM" value="<?php echo set_value('V_reqRM', isset($VRM) == TRUE ? $VRM : 'N/A')?>" size="10" class="form-control-button2"><span class="space"></span></div>
                              <div class="p-vo-4"><span class="ui-left_mobile">Rate : </span><input type="text" id="V_reqRate" name="V_reqRate" value= "1.3" size="10" class="form-control-button2" readonly><span class="space"></span></div>
                              <div class="p-vo-5"><span class="ui-left_mobile">Total : </span><input type="text" id= "V_reqtotal"  name="V_reqtotal" value="<?php echo set_value('V_reqtotal', isset($VTrate) == TRUE ? $VTrate : 'N/A')?>" size="5" class="form-control-button2" readonly></div>
                        </td>
                  </tr>
                  <tr>
                        <td class="td-assest" valign="top">User Verification : </td>
                        <td><input type="text" name="name" value="<?php echo set_value('name',isset($record[0]->v_ReschAuthBy) == TRUE ? $record[0]->v_ReschAuthBy : 'N/A') ?>" class="form-control-button2"></td>
                        <!--<td><input type="text" name="name" value="<?= isset($name) ? $this->input->post('name') : '' ?>" class="form-control-button2" onclick='javascript:fg_popup_form("fg_formContainer","fg_form_InnerContainer","fg_backgroundpopup");' readonly></td>--> 
                  </tr>
      ...
      <!--<?php require_once('contact-wouser.php');?>-->
</div>
