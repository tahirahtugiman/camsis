...
<?php include('language.php'); ?>
	...
	<div class="form">
			...
			<tr>
				<td style="padding-left:5px; width:160px;"><img src="<?php echo base_url(); ?>images/penmedic2.png" style="width:150px; height:50px;"/></td>
				<td>
		...
		<table class="tbl-wo" border="0" align="center" style="color:black;">
			<tr>
				<td style="width:33.33;"><b>PROJECT : </b> IIUM TEACHING HOSPITAL, KUANTAN</td>
				<td style="width:33.33;"><b>a) Location No : <?= $loc ?></b> </td>
				<td style="width:33.33;"><b>c) Document No : </b></td>
			</tr>
			<tr>
				<td style="width:33.33;"><b>Department : <?= $dept ?></b></td>
				<td style="width:33.33;"><b>b) Dispenser No :  </b> </td>
				<td style="width:33.33;"><b>d) Bin No : </b></td>
			</tr>
			<form method="get" action="">
			<tr>
				<td colspan="3"><b>Date :  <input type="text" id="date0" name="jobdate" value="<?php echo set_value("jobdate",date("d/m/Y",strtotime($job_D)))?>" style="width:11%;" onchange="this.form.submit()" class="inputdate"/> </b></td>
			</tr>
		...
		<table class="tftabler" border="1" style="text-align:center; width:90%;" align="center">
			<tr>
				<td colspan="4" align="left" width="40%" style="padding-left:5px;"><?=$lname?> :</td>
				<td colspan="3" align="left">&nbsp;</td>
				<td colspan="3" align="left">&nbsp;</td>
				<td colspan="3" align="left">&nbsp;</td>
			</tr>
			<tr>
				<td colspan="4" align="left" style="padding-left:5px;">Waktu Mula Kerja :</td>
				<td colspan="3" align="left">&nbsp;</td>
				<td colspan="3" align="left">&nbsp;</td>
				<td colspan="3" align="left">&nbsp;</td>
			</tr>
			<tr>
				<td colspan="4" align="left" style="padding-left:5px;">Tamat Mula Kerja :</td>
				<td colspan="3" align="left">&nbsp;</td>
				<td colspan="3" align="left">&nbsp;</td>
				<td colspan="3" align="left">&nbsp;</td>
			</tr>
			<tr>
				<th colspan="4">SKOP PEMBERSIHAN (CLEANSING) :</th>
				<th rowspan="2" colspan="3">SYIF 1</th>
				<th rowspan="2" colspan="3">SYIF 2</th>
				<th rowspan="2" colspan="3">SYIF 3</th>
			</tr>
			<tr>
				<th>1</th>
				<th>LANTAI (Floor)</th>
			...
			<tr>
				...
				<td>Menyapu (Sweeping) lokasi yang dibenarkan </td>
				<td>&nbsp;</td>
			...
			<tr>
				<th colspan="3">2 PERABOT, PERKAKAS, PERALATAN <br />(Furniture, Fitting & Equipment)</th>
				<th>Frekueansi</th>
				<th>&nbsp;</th>
				<th>&nbsp;</th>
				<th>&nbsp;</th>
			...
			<tr>
				<th colspan="3">3 TANDAS (Toilet)</th>
				<th>Frekueansi</th>
				<th>&nbsp;</th>
				<th>&nbsp;</th>
				<th>&nbsp;</th>
			...
			<tr>
				<th colspan="3">4 BAHAN PAKAI BUANG (Consumables)</th>
				<th>Frekueansi</th>
				<th>&nbsp;</th>
				<th>&nbsp;</th>
				<th>&nbsp;</th>
			...
			<tr>
				...
				<td>Pastikan Tuala Kertas (Paper hand towel) mencukupi </td>
				<td>&nbsp;</td>
			...
			<tr>
				...
				<td>Pastikan tisu tandas (toilet jumbo roll) mencukupi </td>
				<td>&nbsp;</td>
			...
			<tr>
				...
				<td>Pastikan sabun tandas pencuci tangan (hand soap) mencukupi </td>
				<td>&nbsp;</td>
			...
			<tr>
				...
				<td>Pastikan pewangi (deodorisers) mencukupi </td>
				<td>&nbsp;</td>
			...
			<tr>
				<th colspan="3">5 TONG SAMPAH DOMESTIK (Toilet)</th>
				<th>Frekueansi</th>
				<th>&nbsp;</th>
				<th>&nbsp;</th>
				<th>&nbsp;</th>
			...
			<tr>
				...
				<td>Memungut Sampah (waste collection) </td>
				<td>&nbsp;</td>
			...
			<tr>
				<th colspan="4">6 RUMUSAN (Summary)</th>
				<th>&nbsp;</th>
				<th>&nbsp;</th>
				<th>&nbsp;</th>
				<th>&nbsp;</th>
			...
			<tr>
				<td colspan="3" align="left" style="padding-left:5px;">No of Cleaning Not Carried Out</td>
				<td>&nbsp;</td>
				<td>&nbsp;</td>
				<td>&nbsp;</td>
				<td>&nbsp;</td>
			...
			<tr>
				<td colspan="3" align="left" style="padding-left:5px;">No of Cleaning Not to Schedule</td>
				<td>&nbsp;</td>
				<td>&nbsp;</td>
				<td>&nbsp;</td>
				<td>&nbsp;</td>
			...
			<tr>
				<td colspan="3" align="left" style="padding-left:5px;">No of Empty Dispensers</td>
				<td>&nbsp;</td>
				<td>&nbsp;</td>
				<td>&nbsp;</td>
				<td>&nbsp;</td>
			...
			<tr>
				<td colspan="3" align="left" style="padding-left:5px;">No of waste Collection Not Carried Out</td>
				<td></td>
				<td colspan="2"></td>
				<td ></td>
				<td colspan="2"></td>
			...
			<tr>
				<td colspan="3" align="left" style="padding-left:5px;">No of waste Collection Not to Schedule</td>
				<td></td>
				<td colspan="2"></td>
				<td ></td>
				<td colspan="2"></td>
			...
			<tr>
				<td colspan="4" align="left" style="padding-left:5px;" height="40px">Disemak oleh Advance Pact Sdn Bhd : <br />(Name , Tandatangan & Tarikh)</td>
				<td colspan="3" align="left" style="padding-left:5px;" valign="top"> NAMA PENYELIA </td>
				<td colspan="3" align="left" style="padding-left:5px;" valign="top"> NAMA PENYELIA </td>
				<td colspan="3" align="left" style="padding-left:5px;" valign="top"> NAMA PENYELIA </td>
			</tr>
			<tr>
				<td colspan="4" align="left" style="padding-left:5px;" height="40px">Disahkah Oleh Staf Hospital : <br />(Name , Tandatangan & Tarikh)</td>
				<td colspan="3" align="left" style="padding-left:5px;" valign="top"> NAMA STAF HOSPITAL </td>
				<td colspan="3" align="left" style="padding-left:5px;" valign="top"> NAMA STAF HOSPITAL </td>
				<td colspan="3" align="left" style="padding-left:5px;" valign="top"> NAMA STAF HOSPITAL </td>
			</tr>
		</table>
			...
			<tr>
				<td align="left" valign="top" class="ui-td-size">
					<table class="tbl-wo" border="1" align="left" style="width:100%; border: 1px solid black;">
						<tr>
							<td rowspan="3" style="padding-left:5px;">Data Verification</td>
				...
				<td align="left" valign="top" style="padding:5px;" class="ui-td-tulis">
					Catatan : <br />
					1) Pada Ruang Syif, tandakan (/) - Kerja yang selesai, (X) Kerja yang tidak selesai, (TA)-Tiada skop kerja / Tiada dalam jadual<br />
					2) Rumusan (Summary) - Rekodkan bilangan non-conformance yang paling tinggi daripada ketiga-tiga syif<br />
					3) Doc No dijanakan oleh sistem jika berlaku 'exception' dan ditulis oleh syarikat konsesi dalam borang berkenaan<br />
					4) Nyata couse code bagi 'Non-comformance' waste collection not done or not schedule<br />
					5) Nyatakan Waktu Tamat Pungutan di ruang waktu pungutan<br />
					6) Rujukan Cause Code : QH7(User), QH8(Manpower), QH9(Equipments/Tools), QH10(Uncontrolled Environment)<br />
					7) Borang asal untuk Kontraktor dan salinan untuk hospital
				</td>
			</tr>
		</table>
	</div>
