<body>
	<div id="Instruction" class="pr-printer">
		...
		<button onclick="javascript:myFunction('report_print_workorder?none=closed');" class="btn-button btn-primary-button">PRINT</button>
		<button type="cancel" class="btn-button btn-primary-button" onclick="location.href = '<?php base_url();?>report_ppmbulk';">CANCEL</button>
	</div>
	<div class="">
		<table class="tbl-wo" border="1" align="center" style="border: 1px solid black;margin-top:5px;">
			<tr>
				...
				<td style="padding-left:5px; width:150px;" align="center">
					<table class="tbl-wo" border="0" align="center">
						<tr>
							<td align="right"><b style="text-transform: uppercase;">QBP-002 : BFF-005</b></td>
						</tr>
						<tr>
							<td align="right"><b style="">Revision 1.0</b>  </td>
						</tr>
						<tr>
							<td align="right"><b style=""><?= date("j-M-y")?></b></td>
						</tr>
					</table>
				</td>
			</tr>
				...
				<td style="width:50%; padding:5px;" rowspan="0"> 
					<table class="tbl-wo-1" border="0" align="left">
						...
						<tr>
							...
							<td><span style="color:blue;">: <?= ($woinfo[0]->V_Equip_code) ? $woinfo[0]->V_Equip_code : 'NA' ?> </span></td>
						</tr>
						<tr>
							...
							<td style="width:;">: <span style="color:blue;"><?= ($woinfo[0]->V_Asset_no) ? $woinfo[0]->V_Asset_no : 'NA' ?></span></td>
							<?php } ?>
						</tr>
						<tr>
					...
					<table class="tbl-wo-1" border="0" align="left">
						...
						<td> 
							<table class="tbl-wo" border="0" align="left">
								<tr>
									<td style="width:33.33%;"> : <div class="box2">
									<?php if(date("d/m/Y", strtotime($woinfo2[0]->V_Wrn_end_code)) < date("d/m/Y")){?>
									<img src="<?php echo base_url(); ?>images/tick2.png" class="img-tick"/>
									<?php }else{ ?>
			...
			<tr>
				<td colspan="2" style="padding:5px;"> 
					<table class="tbl-wo-1" border="0" align="left">
						...
						<?php }else{ ?>
						<tr>
							<td style="padding:5px 5px 5px 5px;"><?= ($woinfo[0]->V_summary) ? $woinfo[0]->V_summary : 'NA' ?></td>
						</tr>
						<?php } ?>
