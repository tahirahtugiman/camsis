			...
			<tr>
				<td style="width:50%; padding:1px;" rowspan="2" valign="top">
					<table class="tbl-wo-1 font-10" border="0" align="left">
						...
						<tr>
							<td><p style="border-bottom: 1px dotted black; margin-left: 5px; margin-right: 5px;"><?=isset($resprec[0]->v_ActionTaken) ? $resprec[0]->v_ActionTaken : '&nbsp;'?> <!-- <hr class='dotted' style="margin:10px 5px 5px 5px;" /> --></p></td>
						</tr>
						<tr>
