														...
														<tr>
															...
															<?php 
																$Area_list = array(
																 ...
																 ?>   
															<?php echo form_dropdown('n_Area_list', $Area_list ,'', 'class="dropdown n_wi-date2"  onchange="getval(this.value);" style="display:inline-block; width:100px; height:30px;"'); ?> </td>
															<?php }elseif ($this->input->get('pro') == 'edit' ){?>
