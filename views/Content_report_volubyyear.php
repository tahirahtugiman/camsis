...
<div id="Instruction" class="pr-printer">
    ...
    <button onclick="javascript:myFunction('report_volubyyear?m=<?=$month?>&y=<?=$year?>&ex=&stat=<?=$this->input->get('stat');?>&grp=<?=$this->input->get('grp');?>&wid=1&req=<?=$this->input->get('req');?>&broughtfwd=<?=$this->input->get('broughtfwd')?>&serv=<?=$this->input->get('serv')?>');" class="btn-button btn-primary-button">PRINT</button>
