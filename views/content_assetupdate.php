						...
						<tr >
							<td class="ui-desk-style-table">
								...
								<tr>
									...
									<td><?=$asset_det[0]->V_username?></a></td>
								</tr>
								<tr>
									<td class="td-assest">Group:&nbsp;</td>
									<td><?=$asset_UMDNS[0]->Asset_Group?></a></td>
								</tr>
								
								<tr><td colspan="3" class="ui-bottom-border-color" style="font-weight: bold;">UMDNS Classification</td></tr>
							...
							<td class="ui-desk-style-table">
								<table class="ui-content-form" width="100%" border="0">	
									...
									<tr>
										...
										<td><?=$asset_det[0]->V_File_Ref_no?></a></td>
									</tr>
									<tr>
										<td class="td-assest">Cost&nbsp;:&nbsp;</td>
										<td>RM<?=$asset_det[0]->N_Cost?></a></td>
									</tr>
									<tr>
										<td class="td-assest">LPO&nbsp;Number&nbsp;:&nbsp;</td>
										<td><?=$asset_det[0]->V_PO_no?></a></td>
									</tr>
									<tr>
							...
							<td class="ui-desk-style-table">
								<table class="ui-content-form" width="100%" border="0">	
									...
									<tr>
										...
										<br/>STILL UNDER WARRANTY</span></td>
										<?php } else { ?>
										<td>
										<?= ($asset_det[0]->V_Wrn_end_code) ? ($asset_det[0]->V_Wrn_end_code != '0000-00-00 00:00:00' ? date("d-m-Y",strtotime($asset_det[0]->V_Wrn_end_code)) : '-' ) : 'N/A' ?>
										<br/>POST WARRANTY</td>
						...
						<tr >
							<td class="ui-desk-style-table">
								<table class="ui-content-form" width="100%" border="0">	
									...
									<tr><td colspan="3" class="ui-bottom-border-color" style="font-weight: bold;"><b>Variation Order</b></td></tr>
									<tr style="height:20px;">
									...
									<tr style="height:20px;">
										<td class="theadap" align="left" colspan="2">
											<table style="color:black; font-size:14px;">
												<tr><td colspan="2" class="ui-bottom-border-color" style="font-weight: bold; color:black;"><b>Current VO Claim</b></td></tr>
												<tr style="height:20px;">
												...
												<tr style="height:20px;" class="td-assest2">
													...
													<td><?= isset($asset_vo[0]->vvfAssetLockedStatus) == TRUE ? $asset_vo[0]->vvfAssetLockedStatus : 'N/A'?><b><?=isset($asset_vo[0]->vvfAssetLockedBy) == TRUE ? $asset_vo[0]->vvfAssetLockedBy : 'N/A'?></b></td>
												</tr>
												<tr style="height:20px;" class="td-assest2">
													<td class="ui-right">PMSB&nbsp;Authorization&nbsp;:&nbsp;</td>
													<td><?= isset($asset_vo[0]->vvfAuthorizedStatus) == TRUE ? $asset_vo[0]->vvfAuthorizedStatus : 'N/A'?><b><?= isset($asset_vo[0]->vvfAuthorizedBy) == TRUE ? $asset_vo[0]->vvfAuthorizedBy : 'N/A'?></b></td>
												</tr>
												<tr style="height:20px;" class="td-assest2">
