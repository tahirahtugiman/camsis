	...
	<table class="tftable" border="1" style="text-align:center; width:70%;" align="center">
		...
		<tr style="text-align:center;font-weight:bold;">
			...
			<tr style="text-align:center;">
			  ...
			  <td><?php if ($rqsum[0]->total == 0) { echo "0"; } else {echo anchor('contentcontroller/report_volu?m='.$month.'&y='.$year.'&req='.$reqtype.'&stat=fbfb&grp=&btp=1'.$this->input->get('grp'),$rqsum[0]->total);} ?></td>
			  <td><?php if ($rqsum[0]->comp == 0) { echo "0"; } else {echo anchor('contentcontroller/report_volu?m='.$month.'&y='.$year.'&req='.$reqtype.'&stat=A&grp=&btp=1'.$this->input->get('grp'),$rqsum[0]->comp);} ?></td>
			  <td><?php if ($rqsum[0]->notcomp == 0) { echo "0"; } else {echo anchor('contentcontroller/report_volu?m='.$month.'&y='.$year.'&req='.$reqtype.'&stat=C&grp=&btp=1'.$this->input->get('grp'),$rqsum[0]->notcomp);} ?></td>
			</tr>
	</table>
