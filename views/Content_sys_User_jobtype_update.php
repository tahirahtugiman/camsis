		...
		<div class="ui-main-form" style="background:#fff;">
			<div class="ui-main-form-header" style="background:#79B6D8;">
				<table align="left" height="40px" border="0">
					<tr>
						<td><span style="margin-left:10px;"><?php if ($this->input->get('sys_id') == ''){echo 'Add';}else{echo 'Edit';}?> Maintenance Service Code Setup </span></td>
					</tr>
				</table>
			</div>
							...
							<tr >
								<td class="ui-desk-style-table">
									...
									<tr>
										...
										<td valign="top"><input type="text" id="n_s_Equipment" name="n_s_Equipment" value="" class="form-control-button2 n_wi-eq3" readonly> <span class="icon-windows" onclick="fEquipment(this)" value="" ></span></td>
										</tr>
										<tr>
										...
										<td valign="top"><input type="text" id="n_Type_Code" name="n_Type_Code" value="" class="form-control-button2 n_wi-eq3" readonly> <span class="icon-windows" onclick="fType(this)" value="" ></span></td>
										</tr>
										<tr>
											<td style="padding-left:10px;" valign="top"></td>
											<td><input type="text" id="n_Type_Code2" name="n_Type_Code2"  value="" class="form-control-button2 n_wi-date2" readonly></td>
										</tr>											
									</table>
								</td>
							</tr>
				...
				<div class="middle_d">
					...
					<tr >
						...
						<tr>
							...
							<td valign="top"><input type="text" id="n_Procedure_Code" name="n_Procedure_Code" value="" class="form-control-button2 n_wi-eq3" readonly> <span class="icon-windows" onclick="fProcedure(this)" value="Labour" ></span></td>
						</tr>
						<tr>
							<td style="padding-left:10px;" valign="top"></td>
							<td><input type="text" id="n_Procedure_Code2" name="n_Procedure_Code2"  value="" class="form-control-button2 n_wi-date2" readonly></td>
						</tr>
						</table>
						</td>
					</tr>
