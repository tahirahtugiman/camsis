	...
	<div class="content-workorder" align="center">
		...
		<table class="ui-desk-style-table3" cellpadding="4" cellspacing="0" width="80%">	
			<tr class="ui-color-contents-style-1" height="40px">
				<td class="ui-header-new" colspan="6"><b>Confirm Referral To Third Party</b></td>
			</tr>
			<tr >
				<td class="ui-desk-style-table" colspan="4">
					<table style="color:black;" width="100%" border="0">	
							...
							<td class="p-left" style="width:50%;" valign="top" colspan="2">
								<table width="100%" style="color:black;">
									<tr>
										...
										<td valign="top">: <textarea class="Input" name="n_Please_specity"  cols="22" rows="3" disabled> </textarea></td>
									</tr>
									<tr>
						...
						<tr>
							...
							<td style="padding-left:5px;" colspan="4" valign="top">: <textarea class="Input" name="n_Please_specity"  cols="37" rows="3" disabled> </textarea></td>
						</tr>
						<tr>
			...
			<tr class="ui-header-new" style="height:40px;">
				<td align="center" colspan="6" >
					<?php echo anchor ('contentcontroller/assetetrttp_confirm', '<button type="button" class="btn-button btn-primary-button" style="width:200px;">Confirm</button>'); ?>
