		...
		<div class="color_style_1 menuprofile">
			...
			<div id="loginBox">                
			  <div id="loginForm">
				...
				<div align="center" class="ui-header-left-color" style="font-weight:bold; margin-top:; padding-top:5px; padding-bottom:5px; color:white;">International Islamic<br />University Malaysia
